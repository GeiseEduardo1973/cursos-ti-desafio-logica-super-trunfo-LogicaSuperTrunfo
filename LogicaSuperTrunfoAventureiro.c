...
int main() {
    ...
    do {
        if ("escolhaJogador") {
            // Turno do jogador
             printf("Escolha uma característica (1 a 7): ");
             scanf("%d", &escolhaJogador);

            // Valor aleatório para o computador
            escolhaComputador = rand() % 100 + 1; // Valor entre 1 e 100
            printf("Computador escolheu o valor: %d\n", escolhaComputador);
            
   
    // Comparar as cartas
    // Desenvolva a logica de comparacao entre duas cartas.
        // Estrutura de decisão para a escolha do jogador
